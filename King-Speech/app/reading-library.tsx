...
const styles = StyleSheet.create({
  ...
  headerSub: { fontSize: 12.5, fontFamily: "Nunito_400Regular", marginTop: 1 },
  ...
  emptyTitle: { fontSize: 18, fontFamily: "Nunito_700Bold", textAlign: "center" },
  emptyBody: { fontSize: 14, fontFamily: "Nunito_400Regular", textAlign: "center", lineHeight: 20 },
});
...
const card = StyleSheet.create({
  ...
  title: { fontSize: 15.5, fontFamily: "Nunito_600SemiBold", letterSpacing: -0.2 },
  author: { fontSize: 13, fontFamily: "Nunito_400Regular", marginTop: 1 },
  metaRow: { marginTop: 4 },
  meta: { fontSize: 11.5, fontFamily: "Nunito_400Regular" },
  ratingsRow: { flexDirection: "row", gap: 18, marginTop: 12 },
  ratingChip: { flexDirection: "row", alignItems: "center", gap: 6 },
  ratingLabel: { fontSize: 11, fontFamily: "Nunito_500Medium", textTransform: "uppercase", letterSpacing: 0.5 },
  deleteBtn: { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 6, paddingVertical: 8 },
  deleteText: { fontSize: 13.5, fontFamily: "Nunito_600SemiBold" },
});
